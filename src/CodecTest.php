...
final class CodecTest extends TestCase
{
    ...
    public function test_it_can_decode_to_string(): void
    {
        ...
        self::assertSame($expected, iterator_to_array((new Decoder())->decode($data)));
    }
    ...
    public function test_it_can_decode_from_a_stream(): void
    {
        ...
        self::assertSame($expected, iterator_to_array((new Decoder())->read($file)));
    }
...
["Alexa",29,true]
LDJSON;
        $tabular = (new Codec())->decode($ldjsonHeader, headerOffset: 0);
...
LDJSON;
    ...
    private function setTabularData(): IteratorAggregate
    {
        $header = ['Name', 'Score'];
        $records = [
            ['Name' => 'Alice', 'Score' => 42],
    ...
    {
        $json = (new Codec())->encode(data: $this->setTabularData(), headerOrOffset: 0, format: Format::ArrayWithHeader);
        $lines = explode("\n", trim($json));
    ...
    public function test_it_writes_the_ndjson_as_a_collectoon_of_array_from_the_tabular_data(): void
    {
        ...
        $written = (new Codec())->write($this->setTabularData(), $path, headerOrOffset: 0, format: Format::ArrayWithHeader);
        self::assertGreaterThan(0, $written);
...
CSV;
        ...
        (new Codec())
            ...
            ->encode(Reader::createFromString($csv), format: Format::ArrayWithHeader);
    }
    ...
    public function test_it_fails_to_map_a_valid_json_string(): void
    {
        ...
        try {
            ...
            self::assertStringContainsString('Unable to map the json line:', $exception->getMessage());
            self::assertSame($line, $exception->getData());
    ...
    public function test_it_fails_to_format_a_valid_json_data(): void
    {
        ...
        try {
            ...
            self::assertSame($line[0], $exception->getData());
            self::assertSame(0, $exception->getOffset());
            self::assertInstanceOf(RuntimeException::class, $exception->getPrevious());
        }
    }
