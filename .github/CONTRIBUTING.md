...
We accept bug reports via issues created on [Github](https://github.com/bakame-php/aide-ndjson/issues).
...
- **Always try the [main branch](https://github.com/bakame-php/aide-ndjson)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/bakame-php/aide-ndjson/pull).
